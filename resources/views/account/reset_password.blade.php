                    ...
                    <div class="details">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="form-group form-box">
                                <input type="password" name="password" class="form-control" placeholder="Enter Your Password " aria-label="Enter Your Password">
                                {{-- thong bao loi --}}
                                @error('password')
                            ...
                            <div class="form-group form-box">
                                <input type="password" name="confirm_password" class="form-control" placeholder="Enter Your  Confirm Password " aria-label="Enter Your  Confirm Password">
                                {{-- thong bao loi --}}
                                @error('password')
                                 <small class="help-block">{{ $message }}</small>
                                @enderror
                            ...
                            <p>Do you have an account?<a href="{{route('account.login')}}"> Login here</a></p>
                        </form>
                    </div>
                </div>
            </div>
